...
def trim_full_results(full_results):
    trimmed = {
        "cumulative_standings": [
            {"user": s["user"], "points": s["points"]}
            for s in full_results["cumulative_standings"]
        ],
        "weeks": []
    }

    for week in full_results["weeks"]:
        trimmed_week = {
            "week": week["week"],
            "games": [
                {
        ...
        for s in week["summary"]:
            ...
            trimmed_week["summary"].append(trimmed_summary)
...
#
# pprint(trimmed_full_results_package)
# print(type(trimmed_full_results_package))